...
def opcao(tela: pygame.Surface):
    ...
    som_images = ['game/geral/som(0).png', 'game/geral/som(0.3).png',
                  'game/geral/som(0.6).png', 'game/geral/som(1).png']
...
def start(tela: pygame.Surface):
    ...
    """
    # Imagens
    start_images = ['game/geral/placa3.png', 'game/1_tela_inicial/novo_jogo.png', 'game/1_tela_inicial/continue.png']
...
def tela_inicial(tela: pygame.Surface):
    ...
    # Som das placas
    placa_som = pygame.mixer.Sound('game/geral/placa.wav')
    # Arquivo save
    ...
    # Background
    tela_menu = Obj('game/1_tela_inicial/fundo.png', 0, 0)
    tittle = Obj('game/1_tela_inicial/titulo.png', 40, 20)
