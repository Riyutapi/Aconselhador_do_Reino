...
def mapa(tela: pygame.Surface):
    ...
    pygame.mixer.music.load('game/1_tela_inicial/Medieval.mp3')
    pygame.mixer.music.play(-1)
    som = 0
    # Imagens do mapa
    imagens = [
        pygame.image.load('game/mapa/mapa_completo.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_cachorro.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_leao.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_porco.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_tatu.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_tigre.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_tordo.png').convert_alpha(),
        pygame.image.load('game/mapa/mapa_caveira.png').convert_alpha()
    ]
...
def cutscene2(tela: pygame.Surface):
    ...
    passar = False
    # Imagens
    rei_feliz = pygame.image.load('game/personagens_cenario/rei-vitoria.png').convert_alpha()
    aconselhador = Obj('game/personagens_falas/aconselhador.png', 43, 476)
    # Variável de controle, Música e sons
    som = 0

    pygame.mixer.music.load('game/geral/Trono.mp3')
    pygame.mixer.music.play(-1)
    pygame.mixer.music.set_volume(som)

    aplauso_som = pygame.mixer.Sound('game/2_corrida_balao/aplausos.wav')
    porta_som = pygame.mixer.Sound('game/2_corrida_balao/porta.wav')
...
def cutscene(tela: pygame.Surface):
    ...
    principe_luto = Obj('game/personagens_falas/principe-velorio.png', 43, 476)
    # Carregar e reproduzir música de fundo
    pygame.mixer.music.load('game/2_corrida_balao/Melancolia.mp3')
    pygame.mixer.music.play(-1)
...
def corrida_balao(tela: pygame.Surface):
    ...
    # Imagens
    rei_triste = pygame.image.load('game/personagens_cenario/rei-derrota.png').convert_alpha()
    quarto_castelo = pygame.image.load('game/2_corrida_balao/quarto_castelo.png').convert()
    rei_derrota = Obj('game/personagens_falas/rei-derrota.png', 43, 476)
    aconselhador = Obj('game/personagens_falas/aconselhador.png', 43, 476)
    sala_trono = pygame.image.load('game/geral/trono.png').convert()
    aconselhador_sala = pygame.image.load('game/personagens_cenario/aconselhador.png').convert_alpha()
