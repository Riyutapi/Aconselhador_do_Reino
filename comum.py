...
def dialogo_completo(nome: str, texto: str, personagem: Obj, binario: int, boolean: bool, tela: pygame.Surface):
    ...
    caixa_dialogo = Obj('game/geral/caixa_dialogo.png', 15, 420)
    fundo_personagem = Obj('game/personagens_falas/1_placa.png', 41, 472)
    avancar_dialogo = Obj('game/geral/avançar_fala.png', 723, 549)
...
def dialogo_por_letra(nome: str, personagem: Obj, texto: str, tela: pygame.Surface):
    ...
    # Som da fala
    fala_som = pygame.mixer.Sound('game/personagens_falas/fala.wav')
